...
public class LocationUpdatesService extends Service {
    ...
    @Override
    public void onCreate() { requestQueue = Volley.newRequestQueue(getApplicationContext());
    ...
    private void sendInfo(final String lat, final String lng) {
        ...
        String url ="https://delivery.lacasadelasenchiladas.pe/api/entrega/enviar_tracking";
        stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("punto_x",lat);
                parametros.put("punto_y",lng);
                parametros.put("app","true");
                parametros.put("tn",token);*/
                Log.e(TAG, "mare" + lat +  " - "+ lng +" // ");


                // Toast.makeText(LocationUpdatesService.this, "mare" + lat +  " - "+ lng +" // "+ preferences.getToken(), Toast.LENGTH_SHORT).show();

                Log.e(TAG, "getParams: " +parametros );
                return parametros;
